# Script — 09 - KTs sur monotone une surcarte tombe face a un reg

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : KTs sur monotone, une surcarte tombe, face à un reg
...
En face : le bouton, un régulier solide. Turn A♣ : tu checkes, il mise 12 bb.

Le prix : 1,20 €, dans un pot de 2,55 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 11,65 big blinds. Il fallait passer.

Passer vaut zéro. Suivre : −11,65 — pire que jeter la main. Rien ne bat le fold.
...
- Flop J♦ 7♦ 3♦ : tu checkes, le bouton mise 4 bb, tu paies.
- Turn A♣ : tu checkes, le bouton mise 12 bb.
...
| donnée | valeur |
|---|---|
| équité du héros | 15.2 % |
| action jouée dans la vidéo | Suivre 1.20 € (−11,65 bb) |
| meilleure action | Passer (0,00 bb) |
| coût de l'erreur | 11,65 bb |
| verdict affiché | « erreur » |
| espérance — Passer | 0,00 bb |
| espérance — Relancer Pot | −0,62 bb |
| espérance — Relancer 1/3 pot | −0,64 bb |
| espérance — Relancer Tapis | −2,17 bb |
| espérance — Suivre 1.20 € | −11,65 bb |
