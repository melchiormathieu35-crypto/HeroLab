# 09 - KTs sur monotone une surcarte tombe face a un reg

**Concept** : Quizz · **Potentiel contenu** : 83/100
**Titre interne** : KTs sur monotone, une surcarte tombe, face à un reg
**Spot** : `turn-deuxieme-balle_bb_kts_reg_monotone_surcarte`
...
Une main qui semble jouable ne l'est pas : payer coûte -11.65 bb, alors que passer est la bonne réponse.
...
- Le héros a **15.2 % d'équité**.
- L'action instinctive est **Suivre 1.20 €**, à **-11.65 bb**.
...
- **Différentiel d'EV : 11.65 bb.** Verdict de l'application : « erreur ».
...
|---|---|
| Passer | 0.00 bb |
| Relancer Pot | -0.62 bb |
| Relancer 1/3 pot | -0.64 bb |
| Relancer Tapis | -2.17 bb |
...
| PAYOFF | `00:29.65` `00:32.75` | 80 % · 75 % |
...
Flop: Jd 7d 3d | hero check, BTN bet 4bb, hero call
