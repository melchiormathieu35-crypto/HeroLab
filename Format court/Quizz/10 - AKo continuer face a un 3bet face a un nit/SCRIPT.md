# Script — 10 - AKo continuer face a un 3bet face a un nit

**Vidéo** : `video.webm` · 33.30 s · **Concept** : Quizz
**Situation** : AKo — continuer face à un 3bet face à un nit
...
A♥ K♦ au cutoff. Simple, en apparence.

Préflop : tu relances à 2,5 bb, il relance à 11 bb.

Le prix : 0,85 €, dans un pot de 1,45 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 9,32 big blinds. Il fallait relancer 2.5 bb.

Relancer 2.5 bb : +6,30. Suivre : −3,01 — pire que jeter la main.
...
- NL10 · en face : la petite blinde, profil très serré
...
| donnée | valeur |
|---|---|
| équité du héros | 36.5 % |
| action jouée dans la vidéo | Suivre 0.85 € (−3,01 bb) |
| meilleure action | Relancer 2.5 bb (+6,30 bb) |
| coût de l'erreur | 9,32 bb |
| verdict affiché | « erreur » |
| espérance — Relancer 2.5 bb | +6,30 bb |
| espérance — Relancer Tapis | +4,38 bb |
| espérance — Passer | 0,00 bb |
| espérance — Suivre 0.85 € | −3,01 bb |
