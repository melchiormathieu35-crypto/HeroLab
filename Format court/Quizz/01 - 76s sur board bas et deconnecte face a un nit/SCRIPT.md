# Script — 01 - 76s sur board bas et deconnecte face a un nit

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : 76s sur board bas et déconnecté face à un nit
...
Suivi ? Erreur, dit le moteur. Coût : 7,26 big blinds. Il fallait relancer pot.

Relancer Pot : +4,83. Suivre : −2,43 — pire que jeter la main. Tout l'écart est là.
...
| donnée | valeur |
|---|---|
| équité du héros | 31.5 % |
| action jouée dans la vidéo | Suivre 0.40 € (−2,43 bb) |
| meilleure action | Relancer Pot (+4,83 bb) |
| coût de l'erreur | 7,26 bb |
| verdict affiché | « erreur » |
| espérance — Relancer Pot | +4,83 bb |
| espérance — Relancer 1/3 pot | +4,75 bb |
| espérance — Relancer Tapis | +2,32 bb |
| espérance — Passer | 0,00 bb |
| espérance — Suivre 0.40 € | −2,43 bb |
