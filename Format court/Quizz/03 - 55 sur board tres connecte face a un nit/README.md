# 03 - 55 sur board tres connecte face a un nit

**Concept** : Quizz · **Potentiel contenu** : 89/100
**Titre interne** : 55 sur board très connecté face à un nit
...
Le réflexe (payer) coûte -1.79 bb ; la bonne réponse est relancer pot, à +4.34 bb.
...
- Le héros a **37.1 % d'équité**.
- L'action instinctive est **Suivre 2.00 €**, à **-1.79 bb**.
  Passer valant 0 par construction, ce coup coûte donc plus cher que de jeter la main.
- La meilleure action est **Relancer Pot**, à **+4.34 bb**.
- **Différentiel d'EV : 6.13 bb.** Verdict de l'application : « erreur ».
...
| Relancer 1/3 pot | +4.29 bb |
| Relancer Tapis | +3.25 bb |
| Passer | 0.00 bb |
| Suivre 2.00 € | -1.79 bb |
...
| REVEAL | `00:23.68` `00:26.63` | 87 % · 79 % |
