# Script — 07 - Q9s sur board paire face a un TAG

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : Q9s sur board pairé face à un TAG
...
Q♦ 9♦ en grosse blinde. Simple, en apparence.

En face : le bouton, profil serré-agressif. Flop 8♥ 8♠ 4♣ : tu checkes, il mise 4 bb.

Le prix : 0,40 €, dans un pot de 0,95 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 4,91 big blinds. Il fallait passer.

Passer vaut zéro. Suivre : −4,91 — pire que jeter la main. Rien ne bat le fold.
...
- Flop 8♥ 8♠ 4♣ : tu checkes, le bouton mise 4 bb.
...
| donnée | valeur |
|---|---|
| équité du héros | 17.2 % |
| action jouée dans la vidéo | Suivre 0.40 € (−4,91 bb) |
| meilleure action | Passer (0,00 bb) |
| coût de l'erreur | 4,91 bb |
| verdict affiché | « erreur » |
| espérance — Passer | 0,00 bb |
| espérance — Relancer 1/3 pot | −0,05 bb |
| espérance — Relancer Pot | −0,20 bb |
| espérance — Relancer Tapis | −0,75 bb |
| espérance — Suivre 0.40 € | −4,91 bb |
