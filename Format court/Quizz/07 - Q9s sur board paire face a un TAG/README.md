# 07 - Q9s sur board paire face a un TAG

**Concept** : Quizz · **Potentiel contenu** : 83/100
**Titre interne** : Q9s sur board pairé face à un TAG
**Spot** : `flop-face-mise_bb_q9s_tag_paire`
...
Une main qui semble jouable ne l'est pas : payer coûte -4.91 bb, alors que passer est la bonne réponse.
...
- Le héros a **17.2 % d'équité**.
- L'action instinctive est **Suivre 0.40 €**, à **-4.91 bb**.
...
- **Différentiel d'EV : 4.91 bb.** Verdict de l'application : « erreur ».
...
|---|---|
| Passer | 0.00 bb |
| Relancer 1/3 pot | -0.05 bb |
| Relancer Pot | -0.20 bb |
| Relancer Tapis | -0.75 bb |
| Suivre 0.40 € | -4.91 bb |
...
| PAYOFF | `00:29.65` `00:32.75` | 81 % · 76 % |
