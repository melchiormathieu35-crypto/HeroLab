# 06 - 76s sur board sec tete haute face a un reg

**Concept** : Quizz · **Potentiel contenu** : 83/100
**Titre interne** : 76s sur board sec, tête haute face à un reg
**Spot** : `flop-face-mise_bb_76s_reg_sec-tete-haute`
...
Une main qui semble jouable ne l'est pas : payer coûte -4.80 bb, alors que passer est la bonne réponse.
...
- Le héros a **17.8 % d'équité**.
- L'action instinctive est **Suivre 0.40 €**, à **-4.80 bb**.
...
- **Différentiel d'EV : 4.80 bb.** Verdict de l'application : « erreur ».
...
|---|---|
| Passer | 0.00 bb |
| Relancer Pot | -0.26 bb |
| Relancer Tapis | -0.28 bb |
| Relancer 1/3 pot | -0.34 bb |
| Suivre 0.40 € | -4.80 bb |
...
| TENSION | `00:11.85` `00:14.15` | 91 % · 88 % |
| CHOICE | `00:17.03` `00:20.48` | 86 % · 88 % |
| REVEAL | `00:23.68` `00:26.63` | 87 % · 81 % |
| PAYOFF | `00:29.65` `00:32.75` | 79 % · 75 % |
...
Flop: Kh 8c 3d | hero check, BTN bet 4bb, hero to act
```
