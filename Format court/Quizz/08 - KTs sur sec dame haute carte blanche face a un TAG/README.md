# 08 - KTs sur sec dame haute carte blanche face a un TAG

**Concept** : Quizz · **Potentiel contenu** : 83/100
**Titre interne** : KTs sur sec, dame haute, carte blanche, face à un TAG
**Spot** : `turn-deuxieme-balle_bb_kts_tag_sec-tete-moyenne_blanche`
...
Une main qui semble jouable ne l'est pas : payer coûte -15.21 bb, alors que passer est la bonne réponse.
...
- Le héros a **5.1 % d'équité**.
- L'action instinctive est **Suivre 1.20 €**, à **-15.21 bb**.
...
- **Différentiel d'EV : 15.21 bb.** Verdict de l'application : « erreur ».
...
|---|---|
| Passer | 0.00 bb |
| Relancer Tapis | -1.23 bb |
| Relancer Pot | -1.23 bb |
| Relancer 1/3 pot | -1.23 bb |
...
|---|---|---|
| HOOK | `00:00.93` `00:02.78` | 89 % · 89 % |
| SITUATION | `00:05.45` `00:08.95` | 82 % · 82 % |
| TENSION | `00:11.85` `00:14.15` | 90 % · 88 % |
| CHOICE | `00:17.03` `00:20.48` | 85 % · 88 % |
| REVEAL | `00:23.68` `00:26.63` | 87 % · 81 % |
| PAYOFF | `00:29.65` `00:32.75` | 81 % · 74 % |
