# Script — 08 - KTs sur sec dame haute carte blanche face a un TAG

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : KTs sur sec, dame haute, carte blanche, face à un TAG
...
K♥ 10♥ en grosse blinde. Simple, en apparence.

En face : le bouton, profil serré-agressif. Turn 2♥ : tu checkes, il mise 12 bb.

Le prix : 1,20 €, dans un pot de 2,55 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 15,21 big blinds. Il fallait passer.

Passer vaut zéro. Suivre : −15,21 — pire que jeter la main. Rien ne bat le fold.
...
|---|---|
| équité du héros | 5.1 % |
| action jouée dans la vidéo | Suivre 1.20 € (−15,21 bb) |
| meilleure action | Passer (0,00 bb) |
| coût de l'erreur | 15,21 bb |
| verdict affiché | « erreur » |
| espérance — Passer | 0,00 bb |
| espérance — Relancer Tapis | −1,23 bb |
| espérance — Relancer Pot | −1,23 bb |
| espérance — Relancer 1/3 pot | −1,23 bb |
| espérance — Suivre 1.20 € | −15,21 bb |
