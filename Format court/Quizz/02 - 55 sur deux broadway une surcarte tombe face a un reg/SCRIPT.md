# Script — 02 - 55 sur deux broadway une surcarte tombe face a un reg

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : 55 sur deux broadway, une surcarte tombe, face à un reg
...
5♥ 5♠ au bouton. Simple, en apparence.

En face : la grosse blinde, un régulier solide. Turn A♣ : il mise 9 bb.

Le prix : 4,50 €, dans un pot de 10,25 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 10,53 big blinds. Il fallait passer.

Passer vaut zéro. Suivre : −10,53 — pire que jeter la main. Rien ne bat le fold.
...
### SITUATION — `00:03.70` → `00:10.70` (7.0 s · 19 mots max, proposé : 16)
...
- NL50 · en face : la grosse blinde, un régulier solide
- Préflop : tu relances à 2,5 bb, la grosse blinde paie.
- Flop K♦ Q♠ 7♥ : la grosse blinde check, tu mises 3 bb, la grosse blinde paie.
- Turn A♣ : la grosse blinde mise 9 bb.
...
|---|---|
| équité du héros | 4.1 % |
| action jouée dans la vidéo | Suivre 4.50 € (−10,53 bb) |
| meilleure action | Passer (0,00 bb) |
| coût de l'erreur | 10,53 bb |
| verdict affiché | « erreur » |
| espérance — Passer | 0,00 bb |
| espérance — Relancer Tapis | −0,29 bb |
| espérance — Relancer Pot | −0,36 bb |
| espérance — Relancer 1/3 pot | −0,42 bb |
| espérance — Suivre 4.50 € | −10,53 bb |
