# Script — 05 - 98s sur sec dame haute carte qui connecte face a un nit

**Vidéo** : `video.webm` · 34.30 s · **Concept** : Quizz
**Situation** : 98s sur sec, dame haute, carte qui connecte, face à un nit
...
9♠ 8♠ en grosse blinde. Simple, en apparence.

En face : le bouton, profil très serré. Turn 10♠ : tu checkes, il mise 12 bb.

Le prix : 1,20 €, dans un pot de 2,55 €.

Passer, suivre, ou relancer — les montants sont à l'écran. Tu fais quoi ?

Suivi ? Erreur, dit le moteur. Coût : 28,16 big blinds. Il fallait relancer tapis.

Relancer Tapis : +22,41. Suivre : −5,75 — pire que jeter la main. Tout l'écart est là.
...
- Flop Q♦ 7♣ 2♠ : tu checkes, le bouton mise 4 bb, tu paies.
- Turn 10♠ : tu checkes, le bouton mise 12 bb.
...
- Verdict : erreur.
- Coût : 28,16 bb
- La bonne réponse : relancer tapis
...
| donnée | valeur |
|---|---|
| équité du héros | 31.3 % |
| action jouée dans la vidéo | Suivre 1.20 € (−5,75 bb) |
| meilleure action | Relancer Tapis (+22,41 bb) |
| coût de l'erreur | 28,16 bb |
| verdict affiché | « erreur » |
| espérance — Relancer Tapis | +22,41 bb |
| espérance — Relancer Pot | +16,52 bb |
| espérance — Relancer 1/3 pot | +16,44 bb |
| espérance — Passer | 0,00 bb |
| espérance — Suivre 1.20 € | −5,75 bb |
