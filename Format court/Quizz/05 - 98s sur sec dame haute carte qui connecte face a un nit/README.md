# 05 - 98s sur sec dame haute carte qui connecte face a un nit

**Concept** : Quizz · **Potentiel contenu** : 84/100
**Titre interne** : 98s sur sec, dame haute, carte qui connecte, face à un nit
**Spot** : `turn-deuxieme-balle_bb_98s_nit_sec-tete-moyenne_connexion`
...
Le réflexe (payer) coûte -5.75 bb ; la bonne réponse est relancer tapis, à +22.41 bb.
...
- Le héros a **31.3 % d'équité**.
- L'action instinctive est **Suivre 1.20 €**, à **-5.75 bb**.
  Passer valant 0 par construction, ce coup coûte donc plus cher que de jeter la main.
- La meilleure action est **Relancer Tapis**, à **+22.41 bb**.
- **Différentiel d'EV : 28.16 bb.** Verdict de l'application : « erreur ».
...
| Relancer Pot | +16.52 bb |
| Relancer 1/3 pot | +16.44 bb |
| Passer | 0.00 bb |
| Suivre 1.20 € | -5.75 bb |
...
| CHOICE | `00:17.03` `00:20.48` | 86 % · 88 % |
| REVEAL | `00:23.68` `00:26.63` | 87 % · 80 % |
| PAYOFF | `00:29.65` `00:32.75` | 77 % · 74 % |
