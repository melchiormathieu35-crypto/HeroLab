# Petite paire face à un 3bet

Rushes verticaux prêts à monter — `pre_facing_3bet` · série « Tu fais quoi ici ? »
...
- Le moteur donne au héros **35.5 % d'équité**.
- L'action instinctive — Suivre 2.12 € — vaut **-3.32 bb**. Comme passer vaut 0 par construction, cela veut dire, littéralement, que ce coup coûte plus cher que de jeter la main.
- La meilleure option est **Relancer Tapis**, à **+1.41 bb**.
- L'écart entre les deux, soit le coût de l'erreur, est de **4.74 bb**. Le verdict rendu par l'application est « erreur ».
...
| option | espérance |
|---|---|
| Relancer Tapis | +1.41 bb |
| Relancer 2.5 bb | +1.25 bb |
| Passer | 0.00 bb |
| Suivre 2.12 € | -3.32 bb |
...
Rejouer la production : `node content/produce.mjs --spot pre_facing_3bet`
