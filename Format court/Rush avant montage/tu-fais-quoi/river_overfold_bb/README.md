# Défense de grosse blinde face à un nit

Rushes verticaux prêts à monter — `river_overfold_bb` · série « Tu fais quoi ici ? »
...
- Le moteur donne au héros **39.5 % d'équité**.
- L'action instinctive — Suivre 1.00 € — vaut **-1.02 bb**. Comme passer vaut 0 par construction, cela veut dire, littéralement, que ce coup coûte plus cher que de jeter la main.
- La meilleure option est **Relancer Pot**, à **+4.37 bb**.
- L'écart entre les deux, soit le coût de l'erreur, est de **5.39 bb**. Le verdict rendu par l'application est « erreur ».
...
| option | espérance |
|---|---|
| Relancer Pot | +4.37 bb |
| Relancer 1/3 pot | +4.31 bb |
| Relancer Tapis | +0.20 bb |
| Passer | 0.00 bb |
| Suivre 1.00 € | -1.02 bb |
...
Rejouer la production : `node content/produce.mjs --spot river_overfold_bb`
