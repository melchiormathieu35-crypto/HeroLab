# Video 004 — QQ — continuer face à un 3bet face à un nit

**Titre interne** : QQ — continuer face à un 3bet face à un nit
**Spot** : `pre-face-3bet_btn_qq_nit`
**Potentiel contenu** : 86/100

## Concept

Le réflexe (payer) coûte -1.48 bb ; la bonne réponse est relancer 2.5 bb, à +6.17 bb.
...
- Le héros a **41.4 % d'équité**.
- L'action instinctive est **Suivre 4.25 €**, à **-1.48 bb**.
  Passer valant 0 par construction, ce coup coûte donc plus cher que de jeter la main.
- La meilleure action est **Relancer 2.5 bb**, à **+6.17 bb**.
- **Différentiel d'EV : 7.65 bb.** Verdict de l'application : « erreur ».
...
| 2 | `02-situation.webm` | SITUATION | 2.6 s | Poser la table : position, adversaire, montant à payer. |
...
**Durée totale de matière : 22.0 s.**
...
### `02-situation.webm` — SITUATION · 2.6 s
