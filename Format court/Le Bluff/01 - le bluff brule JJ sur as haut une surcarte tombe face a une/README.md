# 01 - le bluff brule JJ sur as haut une surcarte tombe face a une

**Concept** : Le Bluff · **Potentiel contenu** : 75/100
**Titre interne** : Le bluff brûle : JJ sur as haut, une surcarte tombe, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_jj_station_as-haut_surcarte`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 48 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 20.71 bb.
...
|---|---|
| Passer | 0.00 bb |
| Suivre 1.20 € | -15.26 bb |
| Relancer 1/3 pot | -20.71 bb |
| Relancer Pot | -21.99 bb |
| Relancer Tapis | -26.97 bb |
...
| REVEAL | `00:19.23` `00:23.68` | 73 % · 75 % |
| LA LEÇON | `00:27.90` `00:31.90` | 80 % · 74 % |
