# 04 - le bluff brule Q9s sur deux broadway carte blanche face a une

**Concept** : Le Bluff · **Potentiel contenu** : 75/100
**Titre interne** : Le bluff brûle : Q9s sur deux broadway, carte blanche, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_q9s_station_deux-broadway_blanche`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 48 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 21.35 bb.
...
|---|---|
| Passer | 0.00 bb |
| Suivre 3.00 € | -15.31 bb |
| Relancer 1/3 pot | -21.35 bb |
| Relancer Pot | -22.68 bb |
| Relancer Tapis | -31.85 bb |
...
| LE PARI | `00:11.08` `00:15.03` | 86 % · 88 % |
