# 02 - le bluff brule 88 sur sec dame haute carte qui connecte face a

**Concept** : Le Bluff · **Potentiel contenu** : 75/100
**Titre interne** : Le bluff brûle : 88 sur sec, dame haute, carte qui connecte, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_88_station_sec-tete-moyenne_connexion`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 48 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 21.75 bb.
...
| **LE PARI** | `00:09.10` | `00:17.00` | 7.90 s | Isoler la mise envisagée (Relancer 1/3 pot) : c'est elle qu'il faut juger, pas la main. |
| **REVEAL** | `00:17.00` | `00:25.90` | 8.90 s | La mise (Relancer 1/3 pot) est jouée à l'écran ; le moteur écrit sa propre équation et tranche : le bluff brûle. |
...
|---|---|
| Passer | 0.00 bb |
| Suivre 1.20 € | -15.04 bb |
| Relancer 1/3 pot | -21.75 bb |
| Relancer Pot | -23.08 bb |
| Relancer Tapis | -29.60 bb |
...
|---|---|---|
| HOOK | `00:01.02` `00:03.08` | 91 % · 89 % |
| SITUATION | `00:05.35` `00:07.85` | 82 % · 82 % |
| LE PARI | `00:11.08` `00:15.03` | 87 % · 88 % |
| REVEAL | `00:19.23` `00:23.68` | 75 % · 75 % |
| LA LEÇON | `00:27.90` `00:31.90` | 80 % · 73 % |
...
Flop: Qd 7c 2s | hero check, BTN bet 4bb, hero call
