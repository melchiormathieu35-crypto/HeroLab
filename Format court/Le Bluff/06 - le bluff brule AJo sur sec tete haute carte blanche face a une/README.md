# 06 - le bluff brule AJo sur sec tete haute carte blanche face a une

**Concept** : Le Bluff · **Potentiel contenu** : 68/100
**Titre interne** : Le bluff brûle : AJo sur sec, tête haute, carte blanche, face à une calling station
**Spot** : `turn-apres-call_co_ajo_station_sec-tete-haute_blanche`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 47 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 10.65 bb.
...
| Passer | 0.00 bb |
| Suivre 2.25 € | -6.34 bb |
| Relancer 1/3 pot | -10.65 bb |
| Relancer Pot | -12.41 bb |
| Relancer Tapis | -21.55 bb |
...
| LA LEÇON | `00:27.90` `00:31.90` | 80 % · 72 % |
