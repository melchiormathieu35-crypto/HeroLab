# 07 - le bluff brule 98s sur bas et deconnecte carte blanche face a

**Concept** : Le Bluff · **Potentiel contenu** : 68/100
**Titre interne** : Le bluff brûle : 98s sur bas et déconnecté, carte blanche, face à une calling station
**Spot** : `turn-apres-call_co_98s_station_bas_blanche`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 47 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 7.87 bb.
...
| Passer | 0.00 bb |
| Suivre 2.25 € | -6.46 bb |
| Relancer 1/3 pot | -7.87 bb |
| Relancer Pot | -9.36 bb |
| Relancer Tapis | -13.06 bb |
