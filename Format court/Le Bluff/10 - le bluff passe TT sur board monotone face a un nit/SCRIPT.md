# Script — 10 - le bluff passe TT sur board monotone face a un nit

**Vidéo** : `video.webm` · 33.90 s · **Concept** : Le Bluff
**Situation** : Le bluff passe : TT sur board monotone face à un nit
...
Ce profil donne 53 %. Au-dessus des 25 exigés. Ce pari est le bon coup, à +3,84 big blinds.
