# 10 - le bluff passe TT sur board monotone face a un nit

**Concept** : Le Bluff · **Potentiel contenu** : 49/100
**Titre interne** : Le bluff passe : TT sur board monotone face à un nit
**Spot** : `flop-initiative_hj_tt_nit_monotone`
...
| EV de ce pari | **+3.84 bb** |
| meilleure action | Miser 1/3 pot (+3.84 bb) |
| fold equity **exigée** | **25 %** |
| fold equity **estimée** (ce profil) | **53 %** |
| marge | +28 points |
| équité une fois payé | 42 % |
| le bluff | **PASSE** |
| coût / gain | +3.84 bb |
...
| option | espérance |
|---|---|
| Miser 1/3 pot | +3.84 bb |
| Miser 1/2 pot | +3.67 bb |
| Miser Pot | +3.58 bb |
| Miser 2/3 pot | +3.51 bb |
| Checker | +2.94 bb |
| Miser Tapis | -0.58 bb |
