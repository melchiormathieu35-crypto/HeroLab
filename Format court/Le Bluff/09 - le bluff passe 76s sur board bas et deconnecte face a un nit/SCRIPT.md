# Script — 09 - le bluff passe 76s sur board bas et deconnecte face a un nit

**Vidéo** : `video.webm` · 33.90 s · **Concept** : Le Bluff
**Situation** : Le bluff passe : 76s sur board bas et déconnecté face à un nit
...
Ce profil donne 53 %. Au-dessus des 25 exigés. Ce pari est le bon coup, à +3,97 big blinds.
