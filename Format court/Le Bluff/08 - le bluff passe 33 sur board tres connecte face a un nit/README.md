# 08 - le bluff passe 33 sur board tres connecte face a un nit

**Concept** : Le Bluff · **Potentiel contenu** : 50/100
**Titre interne** : Le bluff passe : 33 sur board très connecté face à un nit
**Spot** : `flop-initiative_hj_33_nit_connecte`
...
| option | espérance |
|---|---|
| Miser 1/3 pot | +2.50 bb |
| Miser 1/2 pot | +2.26 bb |
| Miser Pot | +2.18 bb |
| Miser 2/3 pot | +2.18 bb |
| Checker | +1.92 bb |
| Miser Tapis | -2.35 bb |
...
Flop: 9h 8s 7c | BB check, hero to act
```
