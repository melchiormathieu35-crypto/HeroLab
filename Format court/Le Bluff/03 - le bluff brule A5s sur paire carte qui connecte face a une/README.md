# 03 - le bluff brule A5s sur paire carte qui connecte face a une

**Concept** : Le Bluff · **Potentiel contenu** : 75/100
**Titre interne** : Le bluff brûle : A5s sur pairé, carte qui connecte, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_a5s_station_paire_connexion`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 48 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 21.39 bb.
...
|---|---|
| Passer | 0.00 bb |
| Suivre 3.00 € | -15.57 bb |
| Relancer 1/3 pot | -21.39 bb |
| Relancer Pot | -22.72 bb |
| Relancer Tapis | -31.88 bb |
