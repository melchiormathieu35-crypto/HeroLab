# Script — 05 - le bluff brule A3s sur bas et deconnecte carte qui connecte

**Vidéo** : `video.webm` · 33.90 s · **Concept** : Le Bluff
**Situation** : Le bluff brûle : A3s sur bas et déconnecté, carte qui connecte, face à une calling station
...
>
> **Le principe du Bluff** : Relancer 1/3 pot demande 47 % de folds, ce
...
En face : la grosse blinde, du genre à tout payer.

Relancer 1/3 pot. Il faut 47 % de folds pour que ce pari soit rentable.

Ce profil ne donne que 5 %. Loin des 47 exigés. Ce pari coûte +9,57 big blinds face à lui.
...
### SITUATION — `00:04.10` → `00:09.10` (5.0 s · 14 mots max, proposé : 11)
