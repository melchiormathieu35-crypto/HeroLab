# 05 - le bluff brule A3s sur bas et deconnecte carte qui connecte

**Concept** : Le Bluff · **Potentiel contenu** : 70/100
**Titre interne** : Le bluff brûle : A3s sur bas et déconnecté, carte qui connecte, face à une calling station
**Spot** : `turn-apres-call_co_a3s_station_bas_connexion`
...
Relancer 1/3 pot a l'air d'un bon coup mais demande 47 % de folds — ce profil n'en donne que 5 % : le bluff brûle, coût 9.57 bb.
...
| EV de ce pari | **-9.57 bb** |
| meilleure action | Passer (0.00 bb) |
| fold equity **exigée** | **47 %** |
| fold equity **estimée** (ce profil) | **5 %** |
| marge | -42 points |
| équité une fois payé | 15 % |
| le bluff | **BRÛLE** |
| coût / gain | +9.57 bb |
...
| Passer | 0.00 bb |
| Suivre 2.25 € | -7.05 bb |
| Relancer 1/3 pot | -9.57 bb |
| Relancer Pot | -11.23 bb |
| Relancer Tapis | -14.88 bb |
...
| REVEAL | `00:19.23` `00:23.68` | 74 % · 75 % |
