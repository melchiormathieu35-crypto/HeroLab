# Script — 02 - la cote dit non 33 sur tres connecte une surcarte tombe face a

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit non : 33 sur très connecté, une surcarte tombe, face à un TAG
...
> a 2.8 % — **la cote dit non**. La phrase de comparaison est
...
En face : le bouton, profil serré-agressif.

Payer 6,00 € dans un pot de 12,75 € : ça exige 32 % d'équité. C'est la cote.

Ton équité réelle : 2,8 %. Loin sous les 32. Payer coûte 16,14 big blinds.
...
- En face : le bouton, profil serré-agressif
- Turn A♣ : tu checkes, il mise 12 bb.
