# 02 - la cote dit non 33 sur tres connecte une surcarte tombe face a

**Concept** : La Cote · **Potentiel contenu** : 84/100
**Titre interne** : La cote dit non : 33 sur très connecté, une surcarte tombe, face à un TAG
**Spot** : `turn-deuxieme-balle_bb_33_tag_connecte_surcarte`
...
Le prix exige 32 % d'équité, le héros n'en a que 2.8 % : payer coûte 16.14 bb, la cote disait non.
...
| **LA COTE** | `00:09.80` | `00:16.40` | 6.60 s | Isoler le prix : 6 à payer. |
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 32 %, réel 2. |
...
|---|---|
| à payer | 6.00 € |
| pot au moment de payer | 12.75 € |
| équité **exigée** par le prix | **32 %** |
| équité **réelle** du héros | **2.8 %** |
| écart | -29.2 points |
| la cote dit | **NON** |
| verdict de l'application | « erreur » |
| coût du call | 16.14 bb |
...
| REVEAL | `00:18.33` `00:22.17` | 83 % · 81 % |
