# 08 - la cote dit non KTs sur paire une surcarte tombe face a un reg

**Concept** : La Cote · **Potentiel contenu** : 80/100
**Titre interne** : La cote dit non : KTs sur pairé, une surcarte tombe, face à un reg
**Spot** : `turn-apres-call_co_kts_reg_paire_surcarte`
...
Le prix exige 31 % d'équité, le héros n'en a que 11.5 % : payer coûte 8.09 bb, la cote disait non.
...
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 31 %, réel 11. |
...
| ÉQUITÉ | `00:26.45` `00:31.15` | 86 % · 86 % |
