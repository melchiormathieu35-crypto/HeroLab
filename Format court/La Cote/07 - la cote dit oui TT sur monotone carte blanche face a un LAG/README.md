# 07 - la cote dit oui TT sur monotone carte blanche face a un LAG

**Concept** : La Cote · **Potentiel contenu** : 28/100
**Titre interne** : La cote dit oui : TT sur monotone, carte blanche, face à un LAG
**Spot** : `turn-apres-call_co_tt_lag_monotone_blanche`
...
Le prix exige 31 % d'équité, le héros en a 52.9 % : payer est correct, la cote disait oui.
...
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 31 %, réel 52. |
...
| REVEAL | `00:18.33` `00:22.17` | 81 % · 75 % |
