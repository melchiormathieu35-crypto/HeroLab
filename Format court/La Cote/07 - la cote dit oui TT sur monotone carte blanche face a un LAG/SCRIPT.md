# Script — 07 - la cote dit oui TT sur monotone carte blanche face a un LAG

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit oui : TT sur monotone, carte blanche, face à un LAG
...
> a 52.9 % — **la cote dit oui**. La phrase de comparaison est
...
En face : la grosse blinde, profil large-agressif. Turn 2♥ : il mise 9 bb.

Payer 4,50 € dans un pot de 10,25 € : ça exige 31 % d'équité. C'est la cote.

Ton équité réelle : 52,9 %. Au-dessus des 31 exigés. Payer est correct.
...
- En face : la grosse blinde, profil large-agressif
- Turn 2♥ : il mise 9 bb.
