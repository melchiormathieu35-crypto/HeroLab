# Script — 06 - la cote dit oui 98s sur sec tete haute carte qui connecte face

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit oui : 98s sur sec, tête haute, carte qui connecte, face à un maniac
...
>
> **Le principe de La Cote** : le prix exige 32 % d'équité, le héros en
> a 54.4 % — **la cote dit oui**. La phrase de comparaison est
...
En face : le bouton, profil hyper-agressif.

Payer 1,20 € dans un pot de 2,55 € : ça exige 32 % d'équité. C'est la cote.

Ton équité réelle : 54,4 %. Au-dessus des 32 exigés. Payer est correct.
...
### SITUATION — `00:04.40` → `00:09.80` (5.4 s · 15 mots max, proposé : 7)
...
- En face : le bouton, profil hyper-agressif
- Turn 10♠ : tu checkes, il mise 12 bb.
...
### REVEAL — `00:16.40` → `00:24.10` (7.7 s · 21 mots max, proposé : 13)
