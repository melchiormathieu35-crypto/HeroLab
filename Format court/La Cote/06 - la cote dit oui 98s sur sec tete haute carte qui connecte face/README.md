# 06 - la cote dit oui 98s sur sec tete haute carte qui connecte face

**Concept** : La Cote · **Potentiel contenu** : 29/100
**Titre interne** : La cote dit oui : 98s sur sec, tête haute, carte qui connecte, face à un maniac
**Spot** : `turn-deuxieme-balle_bb_98s_maniac_sec-tete-haute_connexion`
...
Le prix exige 32 % d'équité, le héros en a 54.4 % : payer est correct, la cote disait oui.
...
| **LA COTE** | `00:09.80` | `00:16.40` | 6.60 s | Isoler le prix : 1. |
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 32 %, réel 54. |
...
|---|---|
| à payer | 1.20 € |
| pot au moment de payer | 2.55 € |
| équité **exigée** par le prix | **32 %** |
| équité **réelle** du héros | **54.4 %** |
| écart | +22.4 points |
| la cote dit | **OUI** |
| verdict de l'application | « correct » |
| coût du call | 0.00 bb |
...
|---|---|---|
| HOOK | `00:01.10` `00:03.30` | 89 % · 89 % |
| SITUATION | `00:05.75` `00:08.45` | 82 % · 82 % |
| LA COTE | `00:11.45` `00:14.75` | 88 % · 88 % |
| REVEAL | `00:18.33` `00:22.17` | 82 % · 75 % |
| ÉQUITÉ | `00:26.45` `00:31.15` | 83 % · 85 % |
