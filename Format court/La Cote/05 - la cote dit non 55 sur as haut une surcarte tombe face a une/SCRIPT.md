# Script — 05 - la cote dit non 55 sur as haut une surcarte tombe face a une

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit non : 55 sur as haut, une surcarte tombe, face à une calling station
...
> a 7.5 % — **la cote dit non**. La phrase de comparaison est
...
Ton équité réelle : 7,5 %. Loin sous les 31. Payer coûte 9,41 big blinds.
...
### SITUATION — `00:04.40` → `00:09.80` (5.4 s · 15 mots max, proposé : 11)
