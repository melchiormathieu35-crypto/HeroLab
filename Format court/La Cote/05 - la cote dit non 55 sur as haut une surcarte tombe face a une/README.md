# 05 - la cote dit non 55 sur as haut une surcarte tombe face a une

**Concept** : La Cote · **Potentiel contenu** : 73/100
**Titre interne** : La cote dit non : 55 sur as haut, une surcarte tombe, face à une calling station
**Spot** : `turn-apres-call_co_55_station_as-haut_surcarte`
...
Le prix exige 31 % d'équité, le héros n'en a que 7.5 % : payer coûte 9.41 bb, la cote disait non.
...
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 31 %, réel 7. |
...
|---|---|
| à payer | 0.90 € |
| pot au moment de payer | 2.05 € |
| équité **exigée** par le prix | **31 %** |
| équité **réelle** du héros | **7.5 %** |
| écart | -23.5 points |
| la cote dit | **NON** |
| verdict de l'application | « erreur » |
| coût du call | 9.41 bb |
...
| ÉQUITÉ | `00:26.45` `00:31.15` | 87 % · 86 % |
...
Flop: Ah 9c 4s | BB check, hero bet 3bb, BB call
