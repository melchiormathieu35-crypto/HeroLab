# Script — 10 - la cote dit non A5s sur board sec dame haute face a un TAG

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit non : A5s sur board sec, dame haute face à un TAG
...
>
> **Le principe de La Cote** : le prix exige 30 % d'équité, le héros en
> a 15.1 % — **la cote dit non**. La phrase de comparaison est
...
Payer 0,40 € dans un pot de 0,95 € : ça exige 30 % d'équité. C'est la cote.

Ton équité réelle : 15,1 %. Loin sous les 30. Payer coûte 5,27 big blinds.
...
- En face : le bouton, profil serré-agressif
- Flop Q♦ 7♣ 2♠ : tu checkes, il mise 4 bb.
