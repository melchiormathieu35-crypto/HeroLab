# 10 - la cote dit non A5s sur board sec dame haute face a un TAG

**Concept** : La Cote · **Potentiel contenu** : 83/100
**Titre interne** : La cote dit non : A5s sur board sec, dame haute face à un TAG
**Spot** : `flop-face-mise_bb_a5s_tag_sec-tete-moyenne`
...
Le prix exige 30 % d'équité, le héros n'en a que 15.1 % : payer coûte 5.27 bb, la cote disait non.
...
| **LA COTE** | `00:09.80` | `00:16.40` | 6.60 s | Isoler le prix : 0. |
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 30 %, réel 15. |
...
|---|---|
| à payer | 0.40 € |
| pot au moment de payer | 0.95 € |
| équité **exigée** par le prix | **30 %** |
| équité **réelle** du héros | **15.1 %** |
| écart | -14.9 points |
| la cote dit | **NON** |
| verdict de l'application | « erreur » |
| coût du call | 5.27 bb |
...
| LA COTE | `00:11.45` `00:14.75` | 87 % · 88 % |
| REVEAL | `00:18.33` `00:22.17` | 83 % · 83 % |
| ÉQUITÉ | `00:26.45` `00:31.15` | 84 % · 83 % |
...
Flop: Qd 7c 2s | hero check, BTN bet 4bb, hero to act
```
