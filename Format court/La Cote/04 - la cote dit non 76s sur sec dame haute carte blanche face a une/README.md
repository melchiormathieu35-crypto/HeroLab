# 04 - la cote dit non 76s sur sec dame haute carte blanche face a une

**Concept** : La Cote · **Potentiel contenu** : 75/100
**Titre interne** : La cote dit non : 76s sur sec, dame haute, carte blanche, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_76s_station_sec-tete-moyenne_blanche`
...
Le prix exige 32 % d'équité, le héros n'en a que 3.8 % : payer coûte 15.76 bb, la cote disait non.
...
| équité **réelle** du héros | **3.8 %** |
| écart | -28.2 points |
| la cote dit | **NON** |
| verdict de l'application | « erreur » |
| coût du call | 15.76 bb |
...
| REVEAL | `00:18.33` `00:22.17` | 82 % · 81 % |
| ÉQUITÉ | `00:26.45` `00:31.15` | 86 % · 85 % |
