# Script — 04 - la cote dit non 76s sur sec dame haute carte blanche face a une

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit non : 76s sur sec, dame haute, carte blanche, face à une calling station
...
> a 3.8 % — **la cote dit non**. La phrase de comparaison est
...
Payer 3,00 € dans un pot de 6,38 € : ça exige 32 % d'équité. C'est la cote.

Ton équité réelle : 3,8 %. Loin sous les 32. Payer coûte 15,76 big blinds.
...
### SITUATION — `00:04.40` → `00:09.80` (5.4 s · 15 mots max, proposé : 10)
...
- En face : le bouton, du genre à tout payer
- Turn 2♥ : tu checkes, il mise 12 bb.
