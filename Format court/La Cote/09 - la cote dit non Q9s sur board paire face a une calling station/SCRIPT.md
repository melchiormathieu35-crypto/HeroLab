# Script — 09 - la cote dit non Q9s sur board paire face a une calling station

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit non : Q9s sur board pairé face à une calling station
...
> a 13 % — **la cote dit non**. La phrase de comparaison est
...
Payer 1,00 € dans un pot de 2,38 € : ça exige 30 % d'équité. C'est la cote.

Ton équité réelle : 13 %. Loin sous les 30. Payer coûte 5,65 big blinds.
...
- En face : le bouton, du genre à tout payer
- Flop 8♥ 8♠ 4♣ : tu checkes, il mise 4 bb.
