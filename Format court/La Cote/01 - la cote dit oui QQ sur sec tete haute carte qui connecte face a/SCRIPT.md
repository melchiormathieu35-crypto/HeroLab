# Script — 01 - la cote dit oui QQ sur sec tete haute carte qui connecte face a

**Vidéo** : `video.webm` · 33.50 s · **Concept** : La Cote
**Situation** : La cote dit oui : QQ sur sec, tête haute, carte qui connecte, face à un maniac
...
> a 60.6 % — **la cote dit oui**. La phrase de comparaison est
...
En face : la grosse blinde, profil hyper-agressif. Turn 10♠ : il mise 9 bb.

Payer 4,50 € dans un pot de 10,25 € : ça exige 31 % d'équité. C'est la cote.

Ton équité réelle : 60,6 %. Au-dessus des 31 exigés. Payer est correct.
...
### SITUATION — `00:04.40` → `00:09.80` (5.4 s · 15 mots max, proposé : 15)
...
- En face : la grosse blinde, profil hyper-agressif
- Turn 10♠ : il mise 9 bb.
