# 01 - la cote dit oui QQ sur sec tete haute carte qui connecte face a

**Concept** : La Cote · **Potentiel contenu** : 26/100
**Titre interne** : La cote dit oui : QQ sur sec, tête haute, carte qui connecte, face à un maniac
**Spot** : `turn-apres-call_co_qq_maniac_sec-tete-haute_connexion`
...
Le prix exige 31 % d'équité, le héros en a 60.6 % : payer est correct, la cote disait oui.
...
| **LA COTE** | `00:09.80` | `00:16.40` | 6.60 s | Isoler le prix : 4. |
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 31 %, réel 60. |
...
|---|---|
| à payer | 4.50 € |
| pot au moment de payer | 10.25 € |
| équité **exigée** par le prix | **31 %** |
| équité **réelle** du héros | **60.6 %** |
| écart | +29.6 points |
| la cote dit | **OUI** |
...
| LA COTE | `00:11.45` `00:14.75` | 89 % · 88 % |
| REVEAL | `00:18.33` `00:22.17` | 79 % · 75 % |
| ÉQUITÉ | `00:26.45` `00:31.15` | 83 % · 84 % |
