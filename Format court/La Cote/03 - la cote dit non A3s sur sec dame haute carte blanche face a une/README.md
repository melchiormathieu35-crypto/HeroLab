# 03 - la cote dit non A3s sur sec dame haute carte blanche face a une

**Concept** : La Cote · **Potentiel contenu** : 75/100
**Titre interne** : La cote dit non : A3s sur sec, dame haute, carte blanche, face à une calling station
**Spot** : `turn-deuxieme-balle_bb_a3s_station_sec-tete-moyenne_blanche`
...
Le prix exige 32 % d'équité, le héros n'en a que 3.2 % : payer coûte 15.97 bb, la cote disait non.
...
| **LA COTE** | `00:09.80` | `00:16.40` | 6.60 s | Isoler le prix : 3 à payer. |
| **REVEAL** | `00:16.40` | `00:24.10` | 7.70 s | Le réflexe (payer) est joué ; le moteur écrit lui-même la comparaison à l'écran — exigé 32 %, réel 3. |
...
|---|---|
| à payer | 3.00 € |
| pot au moment de payer | 6.38 € |
| équité **exigée** par le prix | **32 %** |
| équité **réelle** du héros | **3.2 %** |
| écart | -28.8 points |
| la cote dit | **NON** |
| verdict de l'application | « erreur » |
| coût du call | 15.97 bb |
...
|---|---|---|
| HOOK | `00:01.10` `00:03.30` | 89 % · 88 % |
| SITUATION | `00:05.75` `00:08.45` | 82 % · 82 % |
| LA COTE | `00:11.45` `00:14.75` | 88 % · 88 % |
| REVEAL | `00:18.33` `00:22.17` | 84 % · 81 % |
| ÉQUITÉ | `00:26.45` `00:31.15` | 82 % · 85 % |
