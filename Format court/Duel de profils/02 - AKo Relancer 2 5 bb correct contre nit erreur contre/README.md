# 02 - AKo Relancer 2 5 bb correct contre nit erreur contre

**Concept** : Duel de profils · **Potentiel contenu** : 100/100
**Titre interne** : AKo — continuer face à un 3bet face à un nit — puis face à station, la même action bascule
...
Relancer 2.5 bb vaut +6.30 bb contre nit et -8.55 bb contre station : la même action bascule de 14.85 bb quand seul l'adversaire change.
...
|---|---|---|
| équité du héros | 36.5 % | 26.9 % |
| EV de **Relancer 2.5 bb** | **+6.30 bb** | **-8.55 bb** |
| verdict de l'application | « correct » | « erreur » |
| meilleure action | Relancer 2.5 bb | Passer (0.00 bb) |

**La bascule : 14.85 bb** pour la même action, quand seul
...
|---|---|---|
| Relancer 2.5 bb | +6.30 bb | -8.55 bb |
| Relancer Tapis | +4.38 bb | -17.03 bb |
| Passer | 0.00 bb | 0.00 bb |
| Suivre 0.85 € | -3.01 bb | -6.07 bb |
...
|---|---|---|
| HOOK | `00:00.88` `00:02.63` | 89 % · 88 % |
| MANCHE A | `00:04.65` `00:06.95` | 82 % · 82 % |
| CHOICE A | `00:09.35` `00:11.85` | 85 % · 79 % |
| REVEAL A | `00:14.30` `00:16.70` | 84 % · 76 % |
| MANCHE B | `00:18.95` `00:21.05` | 82 % · 82 % |
| TENSION B | `00:23.10` `00:25.10` | 89 % · 87 % |
| REVEAL B | `00:27.38` `00:29.93` | 81 % · 75 % |
| PAYOFF | `00:32.63` `00:35.48` | 79 % · 76 % |
