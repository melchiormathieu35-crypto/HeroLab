# 03 - 55 Relancer Pot correct contre nit erreur contre station

**Concept** : Duel de profils · **Potentiel contenu** : 84/100
**Titre interne** : 55 sur board très connecté face à un nit — puis face à station, la même action bascule
**Spot** : `flop-face-mise_bb_55_nit_connecte`
...
Relancer Pot vaut +4.34 bb contre nit et -1.67 bb contre station : la même action bascule de 6.01 bb quand seul l'adversaire change.
...
| **REVEAL A** | `00:13.10` | `00:17.90` | 4.80 s | Jouer Relancer Pot — le meilleur coup contre ce profil — et montrer la liste des espérances qui le prouve. |
...
| **REVEAL B** | `00:26.10` | `00:31.20` | 5.10 s | Rejouer exactement Relancer Pot contre le second profil : le moteur tranche, verdict et coût à l'écran. |
...
Deux manches, une seule action : **Relancer Pot**.

| | manche A (nit) | manche B (station) |
|---|---|---|
| équité du héros | 37.1 % | 31.9 % |
| EV de **Relancer Pot** | **+4.34 bb** | **-1.67 bb** |
| verdict de l'application | « correct » | « erreur » |
| meilleure action | Relancer Pot | Passer (0.00 bb) |

**La bascule : 6.01 bb** pour la même action, quand seul
...
|---|---|---|
| Relancer Pot | +4.34 bb | -1.67 bb |
| Relancer 1/3 pot | +4.29 bb | -1.13 bb |
| Relancer Tapis | +3.25 bb | -6.92 bb |
| Passer | 0.00 bb | 0.00 bb |
| Suivre 2.00 € | -1.79 bb | -2.63 bb |
...
|---|---|---|
| HOOK | `00:00.88` `00:02.63` | 90 % · 89 % |
| MANCHE A | `00:04.65` `00:06.95` | 82 % · 82 % |
| CHOICE A | `00:09.35` `00:11.85` | 88 % · 87 % |
| REVEAL A | `00:14.30` `00:16.70` | 85 % · 75 % |
| MANCHE B | `00:18.95` `00:21.05` | 82 % · 82 % |
| TENSION B | `00:23.10` `00:25.10` | 90 % · 88 % |
| REVEAL B | `00:27.38` `00:29.93` | 87 % · 79 % |
| PAYOFF | `00:32.63` `00:35.48` | 79 % · 71 % |
...
Flop: 9h 8s 7c | hero check, BTN bet 4bb, hero to act
```
