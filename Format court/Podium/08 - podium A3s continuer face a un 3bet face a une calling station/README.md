# 08 - podium A3s continuer face a un 3bet face a une calling station

**Concept** : Podium des erreurs · **Potentiel contenu** : 81/100
**Titre interne** : Podium : A3s · Q9s · 33
**Spot** : `pre-face-3bet_co_a3s_station`
...
Trois erreurs classées : n°3 à +7.20 bb, n°2 à +9.81 bb, n°1 à +16.37 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — A3s — continuer face à un 3bet face à une calling station. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — Q9s sur pairé, une surcarte tombe, face à un TAG. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — 33 sur deux broadway, une surcarte tombe, face à un TAG. |
...
|---|---|---|---|
| **N°3** | A3s — continuer face à un 3bet face à une calling station | payer | **+7.20 bb** |
| **N°2** | Q9s sur pairé, une surcarte tombe, face à un TAG | payer | **+9.81 bb** |
| **N°1** | 33 sur deux broadway, une surcarte tombe, face à un TAG | payer | **+16.37 bb** |
...
**Erreur n°3** — A3s — continuer face à un 3bet face à une calling station
...
**Erreur n°2** — Q9s sur pairé, une surcarte tombe, face à un TAG
...
Flop: 8h 8s 4c | BB check, hero bet 3bb, BB call
Turn: Ac | BB bet 9bb, hero to act
```

**Erreur n°1** — 33 sur deux broadway, une surcarte tombe, face à un TAG

```
Hero: BB, 3c 3d, 100bb
Table: 6-max, NL50
Villains: BTN (tag, 100bb)
