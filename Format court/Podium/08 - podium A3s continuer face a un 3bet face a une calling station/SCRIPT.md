# Script — 08 - podium A3s continuer face a un 3bet face a une calling station

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : A3s · Q9s · 33
...
Numéro 3 : A♦ 3♦ au cutoff. Payer coûte 7,20 big blinds.

Numéro 2 : Q♦ 9♦ au cutoff. Payer coûte 9,81 big blinds.

La pire du lot. 3♣ 3♦ en grosse blinde. Payer coûte 16,37 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | A3s — continuer face à un 3bet face à une calling station | payer | +7,20 bb | « erreur » |
| N°2 | Q9s sur pairé, une surcarte tombe, face à un TAG | payer | +9,81 bb | « erreur » |
| N°1 | 33 sur deux broadway, une surcarte tombe, face à un TAG | payer | +16,37 bb | « erreur » |
