# 01 - podium AQs continuer face a un 3bet face a un nit KTs sur bas

**Concept** : Podium des erreurs · **Potentiel contenu** : 93/100
**Titre interne** : Podium : AQs · KTs · A3s
**Spot** : `pre-face-3bet_co_aqs_nit`
...
Trois erreurs classées : n°3 à +10.17 bb, n°2 à +14.54 bb, n°1 à +17.64 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — AQs — continuer face à un 3bet face à un nit. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — KTs sur bas et déconnecté, carte blanche, face à un nit. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — A3s sur as haut, carte blanche, face à un nit. |
...
|---|---|---|---|
| **N°3** | AQs — continuer face à un 3bet face à un nit | payer | **+10.17 bb** |
| **N°2** | KTs sur bas et déconnecté, carte blanche, face à un nit | payer | **+14.54 bb** |
| **N°1** | A3s sur as haut, carte blanche, face à un nit | payer | **+17.64 bb** |
...
| ERREUR N°2 | `00:15.05` `00:20.02` | 82 % · 79 % |
...
**Erreur n°3** — AQs — continuer face à un 3bet face à un nit
...
**Erreur n°2** — KTs sur bas et déconnecté, carte blanche, face à un nit

```
Hero: BTN, Kh Th, 100bb
Table: 6-max, NL10
...
**Erreur n°1** — A3s sur as haut, carte blanche, face à un nit
