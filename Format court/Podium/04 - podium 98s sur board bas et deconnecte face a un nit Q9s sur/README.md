# 04 - podium 98s sur board bas et deconnecte face a un nit Q9s sur

**Concept** : Podium des erreurs · **Potentiel contenu** : 87/100
**Titre interne** : Podium : 98s · Q9s · 88
**Spot** : `flop-face-mise_bb_98s_nit_bas`
...
Trois erreurs classées : n°3 à +7.93 bb, n°2 à +10.42 bb, n°1 à +16.76 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — 98s sur board bas et déconnecté face à un nit. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — Q9s sur bas et déconnecté, une surcarte tombe, face à un TAG. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — 88 sur deux broadway, carte qui connecte, face à un fish. |
...
|---|---|---|---|
| **N°3** | 98s sur board bas et déconnecté face à un nit | payer | **+7.93 bb** |
| **N°2** | Q9s sur bas et déconnecté, une surcarte tombe, face à un TAG | payer | **+10.42 bb** |
| **N°1** | 88 sur deux broadway, carte qui connecte, face à un fish | payer | **+16.76 bb** |
...
| ERREUR N°3 | `00:06.37` `00:10.50` | 82 % · 79 % |
...
**Erreur n°3** — 98s sur board bas et déconnecté face à un nit
...
**Erreur n°2** — Q9s sur bas et déconnecté, une surcarte tombe, face à un TAG

```
Hero: BTN, Qd 9d, 100bb
Table: 6-max, NL10
Villains: BB (tag, 100bb)
Preflop: hero raise 2.5bb, BB call
Flop: 6c 5h 2s | BB check, hero bet 3bb, BB call
Turn: Ac | BB bet 9bb, hero to act
```

**Erreur n°1** — 88 sur deux broadway, carte qui connecte, face à un fish

```
Hero: BB, 8h 8s, 100bb
Table: 6-max, NL10
Villains: BTN (fish, 100bb)
Preflop: BTN raise 2.5bb, hero call
Flop: Kd Qs 7h | hero check, BTN bet 4bb, hero call
Turn: Ts | hero check, BTN bet 12bb, hero to act
```
