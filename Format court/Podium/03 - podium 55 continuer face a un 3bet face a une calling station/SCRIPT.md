# Script — 03 - podium 55 continuer face a un 3bet face a une calling station

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : 55 · 98s · TT
...
Numéro 3 : 5♥ 5♠ au cutoff. Payer coûte 8,31 big blinds.

Numéro 2 : 9♠ 8♠ au bouton. Payer coûte 10,43 big blinds.

La pire du lot. 10♣ 10♦ en grosse blinde. Payer coûte 17,06 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | 55 — continuer face à un 3bet face à une calling station | payer | +8,31 bb | « erreur » |
| N°2 | 98s sur sec, dame haute, carte blanche, face à un TAG | payer | +10,43 bb | « erreur » |
| N°1 | TT sur très connecté, carte qui connecte, face à un nit | payer | +17,06 bb | « erreur » |
