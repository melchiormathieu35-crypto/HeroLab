# 03 - podium 55 continuer face a un 3bet face a une calling station

**Concept** : Podium des erreurs · **Potentiel contenu** : 85/100
**Titre interne** : Podium : 55 · 98s · TT
**Spot** : `pre-face-3bet_co_55_station`
...
Trois erreurs classées : n°3 à +8.31 bb, n°2 à +10.43 bb, n°1 à +17.06 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — 55 — continuer face à un 3bet face à une calling station. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — 98s sur sec, dame haute, carte blanche, face à un TAG. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — TT sur très connecté, carte qui connecte, face à un nit. |
...
|---|---|---|---|
| **N°3** | 55 — continuer face à un 3bet face à une calling station | payer | **+8.31 bb** |
| **N°2** | 98s sur sec, dame haute, carte blanche, face à un TAG | payer | **+10.43 bb** |
| **N°1** | TT sur très connecté, carte qui connecte, face à un nit | payer | **+17.06 bb** |
...
**Erreur n°3** — 55 — continuer face à un 3bet face à une calling station
...
**Erreur n°2** — 98s sur sec, dame haute, carte blanche, face à un TAG
...
Flop: Qd 7c 2s | BB check, hero bet 3bb, BB call
Turn: 2h | BB bet 9bb, hero to act
```

**Erreur n°1** — TT sur très connecté, carte qui connecte, face à un nit
...
Flop: 9h 8s 7c | hero check, BTN bet 4bb, hero call
