# 02 - podium KQo continuer face a un 3bet face a une calling station

**Concept** : Podium des erreurs · **Potentiel contenu** : 80/100
**Titre interne** : Podium : KQo · 76s · 98s
**Spot** : `pre-face-3bet_co_kqo_station`
...
Trois erreurs classées : n°3 à +9.78 bb, n°2 à +11.22 bb, n°1 à +17.22 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — KQo — continuer face à un 3bet face à une calling station. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — 76s sur sec, tête haute, une surcarte tombe, face à un TAG. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — 98s sur deux broadway, une surcarte tombe, face à un récréatif. |
...
|---|---|---|---|
| **N°3** | KQo — continuer face à un 3bet face à une calling station | payer | **+9.78 bb** |
| **N°2** | 76s sur sec, tête haute, une surcarte tombe, face à un TAG | payer | **+11.22 bb** |
| **N°1** | 98s sur deux broadway, une surcarte tombe, face à un récréatif | payer | **+17.22 bb** |
...
**Erreur n°3** — KQo — continuer face à un 3bet face à une calling station
...
**Erreur n°2** — 76s sur sec, tête haute, une surcarte tombe, face à un TAG
...
Flop: Kh 8c 3d | BB check, hero bet 3bb, BB call
Turn: Ac | BB bet 9bb, hero to act
```

**Erreur n°1** — 98s sur deux broadway, une surcarte tombe, face à un récréatif

```
Hero: BB, 9s 8s, 100bb
Table: 6-max, NL10
Villains: BTN (rec, 100bb)
