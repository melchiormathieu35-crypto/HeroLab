# 09 - podium A3s sur board bas et deconnecte face a un nit AKo sur

**Concept** : Podium des erreurs · **Potentiel contenu** : 86/100
**Titre interne** : Podium : A3s · AKo · KQo
**Spot** : `flop-face-mise_bb_a3s_nit_bas`
...
Trois erreurs classées : n°3 à +7.13 bb, n°2 à +9.49 bb, n°1 à +16.25 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — A3s sur board bas et déconnecté face à un nit. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — AKo sur monotone, une surcarte tombe, face à un nit. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — KQo sur pairé, une surcarte tombe, face à une calling station. |
...
|---|---|---|---|
| **N°3** | A3s sur board bas et déconnecté face à un nit | payer | **+7.13 bb** |
| **N°2** | AKo sur monotone, une surcarte tombe, face à un nit | payer | **+9.49 bb** |
| **N°1** | KQo sur pairé, une surcarte tombe, face à une calling station | payer | **+16.25 bb** |
...
**Erreur n°3** — A3s sur board bas et déconnecté face à un nit
...
**Erreur n°2** — AKo sur monotone, une surcarte tombe, face à un nit
...
**Erreur n°1** — KQo sur pairé, une surcarte tombe, face à une calling station
...
Preflop: BTN raise 2.5bb, hero call
Flop: 8h 8s 4c | hero check, BTN bet 4bb, hero call
