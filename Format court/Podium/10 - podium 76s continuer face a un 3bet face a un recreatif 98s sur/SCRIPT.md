# Script — 10 - podium 76s continuer face a un 3bet face a un recreatif 98s sur

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : 76s · 98s · Q9s
...
Numéro 3 : 7♥ 6♥ au cutoff. Payer coûte 6,12 big blinds.

Numéro 2 : 9♠ 8♠ au bouton. Payer coûte 9,48 big blinds.

La pire du lot. Q♦ 9♦ en grosse blinde. Payer coûte 16,21 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | 76s — continuer face à un 3bet face à un récréatif | payer | +6,12 bb | « erreur » |
| N°2 | 98s sur monotone, carte blanche, face à une calling station | payer | +9,48 bb | « erreur » |
| N°1 | Q9s sur as haut, une surcarte tombe, face à une calling station | payer | +16,21 bb | « erreur » |
