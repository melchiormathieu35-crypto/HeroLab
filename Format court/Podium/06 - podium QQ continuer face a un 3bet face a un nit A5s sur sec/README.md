# 06 - podium QQ continuer face a un 3bet face a un nit A5s sur sec

**Concept** : Podium des erreurs · **Potentiel contenu** : 85/100
**Titre interne** : Podium : QQ · A5s · KQo
**Spot** : `pre-face-3bet_co_qq_nit`
...
Trois erreurs classées : n°3 à +7.65 bb, n°2 à +9.94 bb, n°1 à +16.62 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — QQ — continuer face à un 3bet face à un nit. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — A5s sur sec, dame haute, une surcarte tombe, face à un nit. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — KQo sur bas et déconnecté, une surcarte tombe, face à une calling station. |
...
|---|---|---|---|
| **N°3** | QQ — continuer face à un 3bet face à un nit | payer | **+7.65 bb** |
| **N°2** | A5s sur sec, dame haute, une surcarte tombe, face à un nit | payer | **+9.94 bb** |
| **N°1** | KQo sur bas et déconnecté, une surcarte tombe, face à une calling station | payer | **+16.62 bb** |
...
| ERREUR N°2 | `00:15.05` `00:20.02` | 82 % · 80 % |
...
**Erreur n°3** — QQ — continuer face à un 3bet face à un nit
...
**Erreur n°2** — A5s sur sec, dame haute, une surcarte tombe, face à un nit

```
Hero: BTN, Ah 5h, 100bb
Table: 6-max, NL10
...
**Erreur n°1** — KQo sur bas et déconnecté, une surcarte tombe, face à une calling station
...
Flop: 6c 5h 2s | hero check, BTN bet 4bb, hero call
