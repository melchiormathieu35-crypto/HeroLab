# Script — 06 - podium QQ continuer face a un 3bet face a un nit A5s sur sec

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : QQ · A5s · KQo
...
Numéro 3 : Q♥ Q♠ au cutoff. Payer coûte 7,65 big blinds.

Numéro 2 : A♥ 5♥ au bouton. Payer coûte 9,94 big blinds.

La pire du lot. K♥ Q♣ en grosse blinde. Payer coûte 16,62 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | QQ — continuer face à un 3bet face à un nit | payer | +7,65 bb | « erreur » |
| N°2 | A5s sur sec, dame haute, une surcarte tombe, face à un nit | payer | +9,94 bb | « erreur » |
| N°1 | KQo sur bas et déconnecté, une surcarte tombe, face à une calling station | payer | +16,62 bb | « erreur » |
