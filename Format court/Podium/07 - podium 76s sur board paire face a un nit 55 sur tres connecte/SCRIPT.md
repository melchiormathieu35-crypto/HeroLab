# Script — 07 - podium 76s sur board paire face a un nit 55 sur tres connecte

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : 76s · 55 · JJ
...
Numéro 3 : 7♥ 6♥ en grosse blinde. Payer coûte 7,62 big blinds.

Numéro 2 : 5♥ 5♠ au cutoff. Payer coûte 9,83 big blinds.

La pire du lot. J♣ J♦ en grosse blinde. Payer coûte 16,56 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | 76s sur board pairé face à un nit | payer | +7,62 bb | « erreur » |
| N°2 | 55 sur très connecté, carte qui connecte, face à un fish | payer | +9,83 bb | « erreur » |
| N°1 | JJ sur bas et déconnecté, carte blanche, face à un nit | payer | +16,56 bb | « erreur » |
