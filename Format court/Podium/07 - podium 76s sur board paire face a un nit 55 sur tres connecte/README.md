# 07 - podium 76s sur board paire face a un nit 55 sur tres connecte

**Concept** : Podium des erreurs · **Potentiel contenu** : 88/100
**Titre interne** : Podium : 76s · 55 · JJ
**Spot** : `flop-face-mise_bb_76s_nit_paire`
...
Trois erreurs classées : n°3 à +7.62 bb, n°2 à +9.83 bb, n°1 à +16.56 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — 76s sur board pairé face à un nit. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — 55 sur très connecté, carte qui connecte, face à un fish. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — JJ sur bas et déconnecté, carte blanche, face à un nit. |
...
|---|---|---|---|
| **N°3** | 76s sur board pairé face à un nit | payer | **+7.62 bb** |
| **N°2** | 55 sur très connecté, carte qui connecte, face à un fish | payer | **+9.83 bb** |
| **N°1** | JJ sur bas et déconnecté, carte blanche, face à un nit | payer | **+16.56 bb** |
...
**Erreur n°3** — 76s sur board pairé face à un nit
...
**Erreur n°2** — 55 sur très connecté, carte qui connecte, face à un fish

```
Hero: CO, 5h 5s, 100bb
Table: 6-max, NL10
Villains: BB (fish, 100bb)
Preflop: hero raise 2.5bb, BB call
Flop: 9h 8s 7c | BB check, hero bet 3bb, BB call
Turn: Ts | BB bet 9bb, hero to act
```

**Erreur n°1** — JJ sur bas et déconnecté, carte blanche, face à un nit
...
Turn: 2h | hero check, BTN bet 12bb, hero to act
```
