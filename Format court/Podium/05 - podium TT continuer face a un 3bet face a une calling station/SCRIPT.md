# Script — 05 - podium TT continuer face a un 3bet face a une calling station

**Vidéo** : `video.webm` · 34.07 s · **Concept** : Podium des erreurs
**Situation** : Podium : TT · KQo · Q9s
...
Numéro 3 : 10♣ 10♦ au cutoff. Payer coûte 7,92 big blinds.

Numéro 2 : K♥ Q♣ au bouton. Payer coûte 10,02 big blinds.

La pire du lot. Q♦ 9♦ en grosse blinde. Payer coûte 16,71 big blinds — le sommet du classement.
...
|---|---|---|---|---|
| N°3 | TT — continuer face à un 3bet face à une calling station | payer | +7,92 bb | « erreur » |
| N°2 | KQo sur très connecté, une surcarte tombe, face à un TAG | payer | +10,02 bb | « erreur » |
| N°1 | Q9s sur sec, tête haute, une surcarte tombe, face à une calling station | payer | +16,71 bb | « erreur » |
