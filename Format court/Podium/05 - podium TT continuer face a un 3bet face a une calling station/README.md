# 05 - podium TT continuer face a un 3bet face a une calling station

**Concept** : Podium des erreurs · **Potentiel contenu** : 79/100
**Titre interne** : Podium : TT · KQo · Q9s
**Spot** : `pre-face-3bet_co_tt_station`
...
Trois erreurs classées : n°3 à +7.92 bb, n°2 à +10.02 bb, n°1 à +16.71 bb — le coût réel, tel que le moteur le calcule.
...
| **ERREUR N°3** | `00:04.30` | `00:12.57` | 8.27 s | Rang 3/3 du podium — TT — continuer face à un 3bet face à une calling station. |
| **ERREUR N°2** | `00:12.57` | `00:22.50` | 9.93 s | Rang 2/3 du podium — KQo sur très connecté, une surcarte tombe, face à un TAG. |
| **ERREUR N°1** | `00:22.50` | `00:34.07` | 11.57 s | Rang 1/3 du podium — Q9s sur sec, tête haute, une surcarte tombe, face à une calling station. |
...
|---|---|---|---|
| **N°3** | TT — continuer face à un 3bet face à une calling station | payer | **+7.92 bb** |
| **N°2** | KQo sur très connecté, une surcarte tombe, face à un TAG | payer | **+10.02 bb** |
| **N°1** | Q9s sur sec, tête haute, une surcarte tombe, face à une calling station | payer | **+16.71 bb** |
...
|---|---|---|
| HOOK | `00:01.08` `00:03.22` | 90 % · 89 % |
| ERREUR N°3 | `00:06.37` `00:10.50` | 82 % · 80 % |
...
**Erreur n°3** — TT — continuer face à un 3bet face à une calling station

```
Hero: CO, Tc Td, 100bb
Table: 6-max, NL10
Villains: SB (station, 100bb)
Preflop: hero raise 2.5bb, SB raise 11bb, hero to act
```

**Erreur n°2** — KQo sur très connecté, une surcarte tombe, face à un TAG

```
Hero: BTN, Kh Qc, 100bb
Table: 6-max, NL10
Villains: BB (tag, 100bb)
Preflop: hero raise 2.5bb, BB call
Flop: 9h 8s 7c | BB check, hero bet 3bb, BB call
Turn: Ac | BB bet 9bb, hero to act
```

**Erreur n°1** — Q9s sur sec, tête haute, une surcarte tombe, face à une calling station
...
Flop: Kh 8c 3d | hero check, BTN bet 4bb, hero call
